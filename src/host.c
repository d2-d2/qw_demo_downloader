...
void Host_Init (int argc, char **argv, int default_memsize) {
	...
	Com_Printf ("\nThinClient version %s\n\n", VersionString());
	Com_Printf(Host_PrintBars("ThinClient Initialized", 38));
	Com_Printf(Host_PrintBars("based on FuhQuake", 38));
